			...
			<div class="row">
				<div class="col-md-4">
						<ul class="announcement-bar__list">
							...
							<li>
								...
								<a href="mailto: PythonParyani@gmail.com" class="text-decoration-none">PythonParyani@gmail.com</a>
							</li>
						</ul>
				</div>	
				<div class="col-md-8 d-flex justify-content-end">
						...
						<ul class="announcement-bar__list">
							...
							<li>
								<i class="bi bi-clock-history rounded-circle" ></i>30 DAYS MONEYBACK GUARRANTY
							</li>
